...
keyword_obj_HST_expanded = bibcat.Keyword(
            ...
            acronyms_casesensitive=["HFF", "ACS", "GOODS", "HUDF", "HDF", "WFC3", "WFPC", "WFPC-1", "WFPC1", "WFPC2", "STIS", "NICMOS", "GHRS", "FOS", "FOC", "CANDELS"],
            acronyms_caseinsensitive=["HST", "HT"],
            do_not_classify=False,
            banned_overlap=["Hubble Legacy Archive"],
            ambig_words=["Hubble"])
...
keyword_obj_JWST_expanded = bibcat.Keyword(
            keywords=["James Webb Space Telescope", "James Webb Telescope", "Webb Space Telescope", "James Webb Space", "Webb Telescope", "NIRCam", "JWST FGS"],
            acronyms_casesensitive=["Q3D", "CEERS", "MIRI", "NIRISS", "TEMPLATES"],
            acronyms_caseinsensitive=["JWST", "JST", "JT"],
            do_not_classify=False,
            banned_overlap=[],
            ambig_words=[])
...
keyword_obj_Roman = bibcat.Keyword(
            ...
            acronyms_casesensitive=["WFIRST", "RST", "NGRST"],
            acronyms_caseinsensitive=[],
            do_not_classify=False,
            banned_overlap=[],
            ambig_words=["Roman"])
