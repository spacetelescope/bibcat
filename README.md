...
You can classify papers using the pretrained models like `BERT` or `RoBERTa`. Please see the following [Quick Start Guide for Pretrained Models](bibcat/pretrained/PRETRAINED_README.md) to get started.

## Using LLM Prompting Method

You can submit paper content to OpenAI's gpt models.  Please see the following [Quick Start Guide for LLM Prompting](bibcat/llm/README.md) to get started.
