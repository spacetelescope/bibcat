...
data = [{
    "bibcode": "1234567890",
    "body": "This is the body of the source dataset."
},{
    "bibcode": "0987654321",
    "body": "This is the body of the second source dataset."
}]
...
@pytest.mark.parametrize("bibcode, index, body_only, exp", [
...
@pytest.mark.parametrize("filepath, bibcode, index, expfile", [
...
@pytest.mark.parametrize("prompt, exp", [
    ('user', 'Tell me about this paper.'),
    ('agent', 'Read the paper given and extract some info.')
], ids=['user', 'agent'])
...
@pytest.mark.parametrize("prompt, content, exp", [
    ('user', 'Hello.  Please tell me about this paper.', 'tell me about this paper.'),
    ('agent', 'You are an information extractor.  Read the paper given and extract some info. Return something good',
