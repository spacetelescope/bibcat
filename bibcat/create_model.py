...
num_papers = 500 #None, or an integer; if an integer, will truncate external .json text dataset to this size
...
# print out the text info summary of each paper.
...
classifier_ML = classes.Classifier_ML(filepath_model=None, fileloc_ML=None, do_verbose=True)


#Initialize an Operator
tabby_ML = classes.Operator(classifier=classifier_ML, mode=mode_modif, keyword_objs=all_kobjs,
