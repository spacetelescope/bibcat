...
dict_tree_possible_values = {
    "subjectmatter": ["is_pron_1st", "is_etal", "is_keyword", "is_term_fig", "is_pron_3rd"],
    "objectmatter": ["is_pron_1st", "is_etal", "is_keyword", "is_term_fig", "is_pron_3rd"],
...
conv_pos_fromtreetonest = {
    ...
    "DIRECT_OBJECT": "objectmatter",
    "PREPOSITION_OBJECT": "objectmatter",
}  # Convert from tree to nest terminology
nest_important_treebools = [
    "is_pron_1st",
    "is_keyword",
    "is_etal",
    "is_pron_3rd",
    "is_term_fig",
]  # List of important booleans to record into a post-grammar nest
nest_important_treebools_superior = [
    "is_pron_1st",
    "is_term_fig",
    "is_etal",
]  # List of important booleans that get merged into main component from linked terms in a nest
nest_unimportant_pos = [
    None,
    "PUNCTUATION",
]  # Any parts-of-speech (pos) that will be ignored+skipped during nest-building
