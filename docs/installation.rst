...
- See more packages found in the conda environment file (envs/bibcat_py310.yml).
...
- Download the conda installation yml file (bibcat/envs/bibcat_py310.yml).
