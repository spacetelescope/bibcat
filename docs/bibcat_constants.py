###FILE: bibcat_constants.py
###PURPOSE: Container for all presets/constants used for the bibcat package.
...
##Modifs
#Modif modes
list_preset_modes = ["none", "skim", "trim", "anon", "skim_anon", "trim_anon", "skim_trim", "skim_trim_anon"]
#none: All words kept
#skim: Useful words kept (e.g., no adjectives)
#trim: Useful clauses kept
#anon: Certain words/phrases replaced with anonymous ones
#
...
thres_supermention = 5 #Minimum number of mentions needed for paper to be "supermention"
...
#ML_bert_model_key = "small_bert/bert_en_uncased_L-4_H-512_A-8"
