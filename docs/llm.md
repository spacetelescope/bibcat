...
To run this script, set the path to the batch files on your command line below. The log file will be created in the `logs/` folder. Then, execute the script from the terminal using:

```bash
./run_bibcat_serial.sh /path/to/batch_files
